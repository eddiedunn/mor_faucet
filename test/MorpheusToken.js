...
describe('MorpheusToken', () => {
  ...
  describe('Deployment', () => {
    const name = 'Morpheus dev'
    const symbol = 'MOR'
    const decimals = 18
    const totalSupply = tokens('42000000')
  ...
  describe('Sending Tokens', () => {
    ...
    describe('Success', () => {
      ...
      it('transfers token balances', async () => {
        expect(await token.balanceOf(deployer.address)).to.equal(tokens(41999900))
  ...
  describe('Delegated Token Transfers', () => {
    ...
    describe('Success', () => {
      ...
      it('transfers token balances', async () => {
        expect(await token.balanceOf(deployer.address)).to.be.equal(ethers.utils.parseUnits('41999900', 'ether'))
